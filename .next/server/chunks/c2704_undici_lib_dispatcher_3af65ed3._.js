module.exports = [
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const UnwrapHandler = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/handler/unwrap-handler.js [app-route] (ecmascript)");
const { ClientDestroyedError, ClientClosedError, InvalidArgumentError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kDestroy, kClose, kClosed, kDestroyed, kDispatch } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/client-h1.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { RequestContentLengthMismatchError, ResponseContentLengthMismatchError, RequestAbortedError, HeadersTimeoutError, HeadersOverflowError, SocketError, InformationalError, BodyTimeoutError, HTTPParserError, ResponseExceededMaxSizeError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kUrl, kReset, kClient, kParser, kBlocking, kRunning, kPending, kSize, kWriting, kQueue, kNoRef, kKeepAliveDefaultTimeout, kHostHeader, kPendingIdx, kRunningIdx, kError, kPipelining, kSocket, kKeepAliveTimeoutValue, kMaxHeadersSize, kKeepAliveMaxTimeout, kKeepAliveTimeoutThreshold, kHeadersTimeout, kBodyTimeout, kStrictContentLength, kMaxRequests, kCounter, kMaxResponseSize, kOnError, kResume, kHTTPContext, kClosed } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const constants = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/llhttp/constants.js [app-route] (ecmascript)");
const EMPTY_BUF = Buffer.alloc(0);
const FastBuffer = Buffer[Symbol.species];
const removeAllListeners = util.removeAllListeners;
let extractBody;
function lazyllhttp() {
    const llhttpWasmData = process.env.JEST_WORKER_ID ? __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/llhttp/llhttp-wasm.js [app-route] (ecmascript)") : undefined;
    let mod;
    ...
    if (useWasmSIMD) {
        try {
            mod = new WebAssembly.Module(__turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/llhttp/llhttp_simd-wasm.js [app-route] (ecmascript)"));
    ...
    /* istanbul ignore next */ if (!mod) {
        ...
        mod = new WebAssembly.Module(llhttpWasmData || __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/llhttp/llhttp-wasm.js [app-route] (ecmascript)"));
    }
 ...
 */ function writeH1(client, request) {
    ...
    if (util.isFormDataLike(body)) {
        if (!extractBody) {
            extractBody = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)").extractBody;
        }
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/client-h2.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { RequestContentLengthMismatchError, RequestAbortedError, SocketError, InformationalError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kUrl, kReset, kClient, kRunning, kPending, kQueue, kPendingIdx, kRunningIdx, kError, kSocket, kStrictContentLength, kOnError, kMaxConcurrentStreams, kHTTP2Session, kResume, kSize, kHTTPContext, kClosed, kBodyTimeout } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { ClientStats } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/util/stats.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
const Request = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/request.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { InvalidArgumentError, InformationalError, ClientDestroyedError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
const { kUrl, kServerName, kClient, kBusy, kConnect, kResuming, kRunning, kPending, kSize, kQueue, kConnected, kConnecting, kNeedDrain, kKeepAliveDefaultTimeout, kHostHeader, kPendingIdx, kRunningIdx, kError, kPipelining, kKeepAliveTimeoutValue, kMaxHeadersSize, kKeepAliveMaxTimeout, kKeepAliveTimeoutThreshold, kHeadersTimeout, kBodyTimeout, kStrictContentLength, kConnector, kMaxRequests, kCounter, kClose, kDestroy, kDispatch, kLocalAddress, kMaxResponseSize, kOnError, kHTTPContext, kMaxConcurrentStreams, kResume } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const connectH1 = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/client-h1.js [app-route] (ecmascript)");
const connectH2 = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/client-h2.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/fixed-queue.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool-base.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { PoolStats } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/util/stats.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
...
const { kConnected, kSize, kRunning, kPending, kQueued, kBusy, kFree, kUrl, kClose, kDestroy, kDispatch } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { PoolBase, kClients, kNeedDrain, kAddClient, kGetDispatcher, kRemoveClient } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool-base.js [app-route] (ecmascript)");
...
const util = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { kUrl } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/connect.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/balanced-pool.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { BalancedPoolMissingUpstreamError, InvalidArgumentError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { PoolBase, kClients, kNeedDrain, kAddClient, kRemoveClient, kGetDispatcher } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool-base.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const { kUrl } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { parseOrigin } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const kFactory = Symbol('factory');
const kOptions = Symbol('options');
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/agent.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { InvalidArgumentError, MaxOriginsReachedError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kClients, kRunning, kClose, kDestroy, kDispatch, kUrl } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/proxy-agent.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { kProxy, kClose, kDestroy, kDispatch } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const Agent = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/agent.js [app-route] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/pool.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { InvalidArgumentError, RequestAbortedError, SecureProxyConnectionError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/connect.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/env-http-proxy-agent.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
const { kClose, kDestroy, kClosed, kDestroyed, kDispatch, kNoProxyAgent, kHttpProxyAgent, kHttpsProxyAgent } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/retry-agent.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/edu-kinder/node_modules/undici/lib/dispatcher/h2c-client.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { connect } = __turbopack_context__.r("[externals]/node:net [external] (node:net, cjs)");
const { kClose, kDestroy } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const Client = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/client.js [app-route] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/edu-kinder/node_modules/undici/lib/dispatcher/dispatcher-base.js [app-route] (ecmascript)");
...
//# sourceMappingURL=c2704_undici_lib_dispatcher_3af65ed3._.js.map